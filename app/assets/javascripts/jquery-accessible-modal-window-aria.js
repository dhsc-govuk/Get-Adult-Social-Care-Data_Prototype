jQuery(document).ready(function($) {
    ...
    $body.on('click', '.js-modal', function(event) {
        ...
        // Chris Harding (25.06.24) - Added in the 'govuk-link' and 'govuk-body' GOV.UK Design System classes
        $modal_code += '<button type="button" id="js-modal-close" class="' + $modal_prefix_classes + 'modal-close govuk-link govuk-body" data-content-back-id="' + modal_content_id + '" data-focus-back="' + $modal_starter_id + '" title="' + $modal_close_title + '">';
        if ($modal_close_img !== '') {
        ...
        if ($modal_title !== '') {
            // Chris Harding (25.06.24) - Added in the 'govuk-heading-l' GOV.UK Design System class
            $modal_code += '<h1 id="modal-title" class="' + $modal_prefix_classes + 'modal-title govuk-heading-l">' + $modal_title + '</h1>';
        }

        if ($modal_text !== '') {
            // Chris Harding (25.06.24) - Added in the 'govuk-body' GOV.UK Design System class
            $modal_code += '<p class="govuk-body">' + $modal_text + '</p>';
        } else {
    ...
    $body.on('click', '#js-modal-close', function() {
            ...
            if (delay != '0s') {
                ...
                setTimeout(function() {
                    // Chris Harding (30.09.19) - Due to conflicting GOV.UK Elements CSS we also need to remove a ".no-scroll-html" class to the HTML
