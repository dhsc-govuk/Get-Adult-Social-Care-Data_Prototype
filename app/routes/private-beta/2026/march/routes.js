module.exports = function(router) {
  ...
  var version = 'private-beta/2026/march';
  const providerLocations = require('../../../../data/private-beta/2026/march/provider-locations.json');
  const careHomeBedsAndOccupancy = require('../../../../data/private-beta/2026/march/residential-care/care-home-beds-and-occupancy.json');
  const numberOfAdultsReceivingCommunitySocialCare = require('../../../../data/private-beta/2026/march/residential-care/number-of-adults-receiving-community-social-care.json');
  const localAuthorityFundingForAdultSocialCare = require('../../../../data/private-beta/2026/march/funding/local-authority-funding-for-adult-social-care.json');
  const laFundingPlanning = require('../../../../data/private-beta/2026/march/future-planning/la-funding-planning.json');
